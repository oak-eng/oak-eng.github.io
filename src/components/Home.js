...
const mediumArticles = [
  {
    ...
    description: "Today we focus on another facet of oak — Black-owned businesses — as we take a look at how the pandemic has affected their operations.",
  ...
  },
  {
    ...
    description: "COVID-19 has changed every aspect of life as we know it. As students, we’ve dealt with the sudden eviction from campus, the loss of on-campus jobs, the challenges of switching to online classes, and transition back home.",
  ...
  },
  {
    ...
    description: "It’s 7 pm, Sunday night, and I’m listening to one of my co-founders present her weekly deliverables to the team. We’re talking about our beta-launch, strategizing to build a tool that matches and exceeds our customer’s expectations.",
...
export default function Home({ mobile }) {
  ...
  const cardContainerClass = mobile ? styles['medium-card-container-mobile'] : styles['medium-card-container'];
  ...
  return (
    <>
      ...
      <div>
        ...
        <div class={`${rowClass} ${styles['testimonial']}`}>
          <Grid
            columns='equal'
            centered
            padded
        ...
        <div class={`${rowClass} ${styles['transform']}`}>
          <h1 class={styles['oak-subtitle']}>
        ...
        <div class={rowClass}>
          ...
          <Header as='h2' textAlign='center'>
            <a class={styles['black-link']} href="https://medium.com/@oaksystems" target="_blank" rel="noopener noreferrer"><Icon name='medium m' size='medium' circular link /></a>
          </Header>
        ...
        <div class={`${rowClass} ${styles['contact']}`}>
          <Header as='h1' textAlign='center'>
            contact us
          </Header>
